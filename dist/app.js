...
exports.io.on("connect", function (socket) {
    socket.on("review_added", function () { return __awaiter(void 0, void 0, void 0, function () {
        var Review, reviews;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    Review = mongoose_1.default.model('Review');
                    return [4 /*yield*/, Review.find()];
                case 1:
                    reviews = _a.sent();
                    exports.io.emit("New_review", { status: "successful", reviews: reviews });
                    return [2 /*return*/];
            }
        });
    }); });
