...
router.post('/add_review', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, comment, rating, review, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                review = new Review({ comment: comment, rating: rating, });
